...
WINDOW_TITLE = "g7c1"
GFX_TILE_SIZE_PX = 64
GFX_TILE_HALF_SIZE_PX = GFX_TILE_SIZE_PX / 2
...
require("src.game.mobs.behaviors.MoveToPlayer")
...
require("src.game.utils.walls_service")
require("src.game.utils.tile_checker")
require("src.game.utils.tile_raycast")
