...
dofile("src/game/inventory/canned_item.lua")
dofile("src/game/inventory/inventory_item_type.lua")
dofile("src/game/objects/items/beacon_map_item.lua")
dofile("src/game/objects/items/canned_map_item.lua")
dofile("src/game/objects/items/map_item.lua")
dofile("src/game/objects/objects/object.lua")
dofile("src/game/objects/objects/beacon_object.lua")
dofile("src/game/objects/objects/crate_object.lua")
